  ...
  /*   Circle selection  */    
   ...
   /*  End of circle selection */    
    ...
    function showAllVariables(){
         totalShape = checkShapes();
        
        todaysDiscountedPrice = discountCalculation(14,30);
        console.log(todaysDiscountedPrice);
        finalPrice = roundTotalPrice(todaysDiscountedPrice,100);
        console.log(finalPrice);
        
        $('h1.showAllVariables').text('All Variables');
    ...
    /* Submit variables to tracker.html */
    $('sender').on("click",function(){
        ...
        console.log('total shape is: '+oddOrEven);
            
        
        showAllVariables(); // Show all vairables
        
        // send variables using ajax 
         sendVariables();
    ...
    function sendVariables(){
         var request = $.ajax({
              ...
              data: {
                  ...
                  triangle:triangleQuantity,
                  circle:circleQuantity
              }
        });
    ...
    // End of function sendVariables 
        ...
        function showDiscountedPrice(){
             bundle1Total = discountCalculation(10.55,50);
             bundle2Total = discountCalculation(14.75,50);
             bundle3Total = discountCalculation(21.40,50);
    ...
    /* End of Display bundle discounted price */                
